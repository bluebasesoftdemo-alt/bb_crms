                        ...
                        <div class="card card-primary ">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    $sql = $con->query("Select a.*,e.full_name,f.dept_name from initiate_installation a LEFT JOIN z_user_master e ON (a.employee=e.candidate_id) LEFT JOIN z_department_master f ON (a.department=f.id)WHERE a.id='$id' ");
