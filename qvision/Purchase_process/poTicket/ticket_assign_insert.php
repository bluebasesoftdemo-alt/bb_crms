...
$update_sts = $con->query("UPDATE po_ticket SET employee='$employee',department='$department',status= '1' WHERE id='$ticket_id'"); //Assign Employee for work /// Status = 1 ////

echo "UPDATE po_ticket SET employee='$employee',department='$department',status= '1' WHERE id='$ticket_id'";
