    ...
    <link rel="stylesheet" href="Qvision\commonstyle.css">
                        ...
                        <div id="salary_view"  style="font-family:'Times New Roman', Times, serif;width: 500px; height: 400px; position: absolute; left: 305px; top: 118px;"> </div>
                            <div class="card-header">
                                <h3 class="card-title"> <font size="5"> Engineer Allocation for Customization </font> </h3>
                            ...
                            <div class="card-body">
                                ...
                                <?php
                                    $sql = $con->query("Select a.* from po_ticket a WHERE a.id='$id' ");
                                    $sqls = $sql->fetch();
                                ?>
...
<script>
    ...
    $("form[name='fupForm']").on("submit", function(ev) {
        ...
        $.ajax({
            url: "qvision/Purchase_process/poTicket/ticket_assign_insert.php",
            method: "POST",
            data: formData,
            cache: false,
            contentType: false,
    ...
    function select_dep(department) {
        ...
        $.ajax({
            url: "qvision/Purchase_process/poTicket/find_emp.php?department="+department,
            type: "GET",
            success: function(data) {
                $("#employee").html(data);
            }
