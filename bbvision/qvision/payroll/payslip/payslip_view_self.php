...
<?php } ?>
	...
	if ($month_days > $work_days) {
		...
		$finaloa = round($otherallowance, 2);
	} else {
		$basicdasal = $getdetails['basic_month'];
		$finalbasic = round($basicdasal, 2);
...
<?php } ?>
    ...
    <td class="right">
	<?php echo round($getdetails['professionaltax_permonth'],2); ?> 
	</td>
  </tr>

  <tr>
    <td class="left" style="font-weight:bold;">Total Earning</td>
	<?php $gross_salary=$basicdasal+$HRA+$otherallowance; ?>
    <td class="right" style="font-weight:bold;"><?php echo number_format($gross_salary,2) ;?></td>
	
	<?php $deduction_total=$pfamount+$esicamount+$getdetails['professionaltax_permonth']; ?>
