...
<div class="tab-content">
    ...
    <form method="POST" enctype="multipart/form-data" action="qvision/Recruitment/project_management/project/project_submit.php">
	<input type="hidden" name="userrole" id="userrole" value="<?php echo  $userrole; ?>">

    <!-- Post -->
    <table class="table table-bordered">
        <tr>
        <td><center><img src="/qvision/Recruitment/image/userlog/quadsel.png" alt="quadsel" style="width:300px;height:150px;"></center></td>
	 ...
	 <td colspan="2">
		...
		<select class="form-control" name="employee[]" id="employee_1">
		  ...
		  function getEmployee_data(v){
			  ...
			  $.ajax({
url: "/qvision/Recruitment/project_management/project/find_emp.php",
type: "GET",
data: {
...
function back()
    ...
    $.ajax({
    type:"POST",
    url:"/qvision/Recruitment/project_management/project/project.php",
