...
<form role="form" name="" action="qvision/Recruitment/project_management/modules/update_modules.php" method="post" enctype="multipart/type">
...
<script>
    ...
    $.ajax({
    type:"POST",
    url:"/qvision/Recruitment/project_management/modules/modules.php",
