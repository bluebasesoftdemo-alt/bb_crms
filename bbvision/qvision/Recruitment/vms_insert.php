...
$query=$con->query("INSERT INTO  vms(`date`, `first_name`, `email`, `mob_num`, `Coming_from`, `companys`, `Purpose`, `Department`, `employee`, `vehicle`, `veh_no`, `Remarks`, `status`) VALUES ('$date', '$first_name','$email','$mob_num','$Coming_from','$companys','$Purpose','$Department','$employee','$vehicle','$Vehicle_No','$Remarks',1)");
